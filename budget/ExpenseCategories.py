...
def main():
    ...
    ##use set comprehension to categorize expenses
    divided_set_comp = expenses.categorize_set_comprehension()

    ##use == test to make sure set comp and for loop methods provide same results
    if divided_set_comp != divided_for_loop:
        print('Sets are NOT equal by == test')

    ##use subset test to make sure set comp and for loop methods provide same results
